...
echo 'export SLACK_BOT_TOKEN=xoxb-your-bot-token-here' >> ~/.zshrc
echo 'export SLACK_APP_TOKEN=xapp-1-your-app-token-here' >> ~/.zshrc
source ~/.zshrc
```
...
echo 'export SLACK_BOT_TOKEN=xoxb-your-bot-token-here' >> ~/.bash_profile
echo 'export SLACK_APP_TOKEN=xapp-1-your-app-token-here' >> ~/.bash_profile
source ~/.bash_profile
```
...
export SLACK_APP_TOKEN=xapp-1-your-token-here
cd /path/to/neo-slack-bot/src
./bin/neo-slack-bot
```
