...
void test_token_format_validation_security() {
    std::vector<std::string> malicious_tokens = {
        ...
        "xoxb-BOT_TOKEN_PLACEHOLDER<script>",
        "xoxb-BOT_TOKEN_PLACEHOLDER; rm -rf",
        "xoxb-BOT_TOKEN_PLACEHOLDER' OR '1'='1",
        "xoxb-BOT_TOKEN_PLACEHOLDER" + std::string(1, '\0') + "null",
        "xoxb-BOT_TOKEN_PLACEHOLDER/../../etc/passwd",
