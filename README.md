...
- **Development**: [NeoZorK/neo-slack-bot](https://github.com/NeoZorK/neo-slack-bot) (Private)
- **Production**: [NeoZorK/neo-slack-bot-production](https://github.com/NeoZorK/neo-slack-bot-production) (Public, stable releases)
...
For detailed troubleshooting, see [docs/troubleshooting-bot-setup.md](docs/troubleshooting-bot-setup.md).

### Quick Check
- **Tokens**: Ensure both `SLACK_BOT_TOKEN` and `SLACK_APP_TOKEN` are set.
- **Socket Mode**: Must be enabled in Slack App settings.
- **OpenSSL**: Required for TLS connection.
